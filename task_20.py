...
for k,v in lst.items(): # разделяем ключи и значение
    for letter in k: # Разделяем ключ на буквы
        dct  = dict.fromkeys(letter, v) # Создаем словари из буквы и значения
        for txt in word: # Разделяем слово
            if letter == txt:
                count += v
print(count)
